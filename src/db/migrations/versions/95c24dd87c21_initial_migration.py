...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('NEW', 'COVER_GENERATED', 'APPLIED', 'REJECTED', 'SKIPPED', name='applicationstatus'), nullable=False),
    ...
    sa.Column('resume_embedding', pgvector.sqlalchemy.vector.VECTOR(dim=768), nullable=True),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
